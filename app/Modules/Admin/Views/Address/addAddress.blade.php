        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="color: rebeccapurple">
                    ...
                    @endif
                    <form class="form" role="form" method="post" action="/admin/addAddress">


                        <div class="row">

                            <div class="form-group floating-label col-md-6">
                                <label for="demo1" style="color: black">Employee ID</label>
                                <input class="form-control" id="demo1" type="text" name="employee_ID"
